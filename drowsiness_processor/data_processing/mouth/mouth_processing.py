...
class MouthPointsProcessing:
    ...
    def calculate_distances(self, mouth_points: dict):
        lips = self.distance_calculator.calculate_distance(mouth_points['distances'][0], mouth_points['distances'][1])
        chin = self.distance_calculator.calculate_distance(mouth_points['distances'][2], mouth_points['distances'][3])
        return lips, chin
