...
class HeadPointsProcessing:
    ...
    def calculate_distances(self, head_points: dict):
        nose_mouth = self.distance_calculator.calculate_distance(head_points['distances'][0], head_points['distances'][1])
        head_front = self.distance_calculator.calculate_distance(head_points['distances'][2], head_points['distances'][3])
